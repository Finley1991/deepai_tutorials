...
def gen_sample(img_path,anno_path,save_path,face_size,stop_value):
            ...
            try:
                ...
                with Image.open(image_file) as img:
                    ...
                    while True:
                        ...
                        if _x1 < 0 or _y1 < 0 or _x2 > img_w or _y2 > img_h or _side_len<face_size:#判断偏移超出整张图片的就跳过，不截图
                            continue
...
if __name__ == '__main__':
    ...
    save_path = r"E:\pycharmprojects\dataset\celeba\train"
    # save_path = r"E:\pycharmprojects\dataset\celeba\validate"

    gen_sample(img_path,anno_path,save_path,12,100)
    gen_sample(img_path,anno_path,save_path,24,100)
    gen_sample(img_path,anno_path,save_path,48,100)